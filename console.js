...
function initConsole() {
	...
	function processInput(input) {
		commands = {
			...
			'hackathons':'<span class="light-blue">&nbsp;HS Hacks @ Paypal HQ</span> <br><span class="green">&nbsp;CodeDay SF @ Lookout HQ &nbsp;</span><br><span class="blue">&nbsp;BeyondHacks @ Facebook HQ &nbsp;</span> <br><span class="blue">&nbsp;HackUCI @ UCI &nbsp;</span><br><span class="gold">&nbsp;SBHacks @ UCSB &nbsp;</span><br>
